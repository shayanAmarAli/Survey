...
const Que14 =
{
  ...
  options: [
    {
      value: "yes, my parents focused on my education from childhood and support me in my career", opt_no: "A",
      label: "Yes, my parents focused on my education from childhood and support me in my career"
    },
    {
      value: "my parents focused on my academic qualification but do not encourage me in my career", opt_no: "B",
      label: "My parents focused on my academic qualification but do not encourage me in my career"
    },
    {
      value: "no, my parents never focused on my education or career", opt_no: "C",
      ...
      <Box height={{ sm: "80%", mm: "80%", md: "80%", lg: "80%", xl: "70%", "2xl": "80%" }}
        ...
        <Box display={"flex"} flexDir={"column"}
          ...
          <Box display={"flex"} flexDirection={"column"}
            ...
            {
              Que14.options.map((data: any, id: number) => {
