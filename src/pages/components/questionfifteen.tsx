...
const Question15 = () => {
  ...
  const Que15 = form_data[14];

  function handleSubmit(data: any) {
    // e.preventDefault()
    setStyle(true)
    setStep(21)
    setFormData({ ...formData, send_school: data })
  }
      ...
      <Box height={{ sm: "80%", mm: "80%", md: "80%", lg: "80%", xl: "70%", "2xl": "80%" }}
        ...
        <Box display={"flex"} flexDir={"column"}
          ...
          <Box width={{ sm: "250px", mm: "250px", md: "450px", lg: "600px", xl: "900px", "2xl": "1200px" }}>
            <Text fontSize={{ sm: "12px", md: "18px", lg: "22px", xl: "34px", "2xl": "44px" }} textColor={"#FFF"}
            >{Que15.text}</Text>
            <Text fontSize={{ sm: "8px", md: "14px", lg: "16px", xl: "26px", "2xl": "34px" }} textColor={"#FFF"}
            >{Que15.subtext}</Text>
          </Box>
          <Box display={"flex"} flexDirection={"column"}
            gap={{ sm: "8px", md: "12px", lg: "14px", xl: "16px", "2xl": "30px" }} >
            {
              Que15.options.map((data: OptionType, id: number) => {
                return <Box border={"1px"} borderColor={"white"}
                  ...
                  width={{ sm: "170px", mm: "200px", md: "250px", lg: "330px", xl: "450px", "2xl": "800px" }}
                ...
                >
                  <Box
                    ...
                    paddingX={{ sm: "2px", md: "4px", lg: "2px", xl: "6px", "2xl": "6px" }}
                    fontSize={{ sm: "8px", md: "10px", lg: "10px", xl: "14px", "2xl": "22px" }}
                    textColor={"white"}
                    textAlign={"center"}
                  >{data.opt_no}</Box>
                  <Text
